...
local Tab2 = Page:CreateSection({Name = "Setting AuToFarm", Side = "Right"})-- ชื่อ ตำแหน่ง Left/Right
...
local SelectWeapon = Tab2:AddDropdown({
	...
	Value = _G.ConfigTestDropdownNormal, -- ค่าที่จะให้มันเลือก
	List = ItemList,
...
----------------------
local Othor1 = Page:CreateSection({Name = "Othor", Side = "Left"})-- ชื่อ ตำแหน่ง Left/Right
    ...
    local placeId = game.PlaceId;
                         ...
                         function CheckQuest()
                            ...
                            elseif MyLevel == 300 or MyLevel <= 329 then -- Military Soldier
                                ...
                                CFrameMon = CFrame.new(-5363.01123, 41.5056877, 8548.47266, -0.578253984, -3.29503091e-10, 0.815856814, 9.11209668e-08, 1, 6.498761e-08, -0.815856814, 1.11920997e-07, -0.5782539
